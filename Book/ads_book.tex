...
\\~\\
Para o Bootstrap, \textbf{todas as páginas} serão sempre divididas em 12 colunas. A lógica de divisão é como na tabela abaixo:
\tiny
...
\begin{tabular}{|cccccccc|cccc|}
	\hline
	.col-md-8 & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} & col.md-4 & \phantom{.col-md-1} & \phantom{.col-md-1} & \phantom{.col-md-1} \\
	\hline
\end{tabular}
\normalsize
