...
\begin{tabular}{|l|l|l|}
\hline
\textbf{Regre de Inferência} & \textbf{Nome} & \textbf{Nota} \\
\hline
\hline
...
\begin{itemize}
	...
	\item Passo indutivo (Provar que $P(n) \implies P(n+1)$)
\end{itemize}

Temos que ter cuidado com o passo básico. Afirmar que $P(n=1)$ é verdadeiro \textbf{não é} provar. Similarmente, no passo indutivo, também não podemos assumir que $P(n)$ é verdade sem tomar muito cuidado. O ideial é que $P(n)$ seja evidentemente verdadeira.
