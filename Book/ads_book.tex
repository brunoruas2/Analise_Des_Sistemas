...
\subsubsection{Etapas de um Algoritmo e o Operador de Atribuição}
...
\textbf{Objeto Window}
\\~\\
O objeto window é o representante da camada de software que contém o browser do user. Ele contém toda a hierarquia que mostramos nessa lista de elementos acima. Além de conter todos esses elementos dentro dele, esse objeto\footnote{Como o próprio nome diz, tudo no DOM são, em algum grau, objetos.Mantenha isso em mente!} possui métodos e propriedades que são úteis para o gerenciamento das nossas aplicações.
\\~\\
