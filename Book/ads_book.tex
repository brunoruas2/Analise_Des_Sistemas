...
Os \textbf{artefatos} são um dos produtos que as atividades técnicas e gerencias produzem em cada ciclo de trabalho.
\\~\\
Eles fornecem a descrição e definição dos outros produtos tangíveis durante o esforço. Existem vários tipos, vamos elencar alguns:
\begin{itemize}
...
Agora vamos aprofundar um pouco mais em alguns desses artefatos que são importantes para o bom trabalho de engenharia de software.
