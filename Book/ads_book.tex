...
\\~\\
Em JS podemos definir os dados em dois grandes grupos. O primeiro é chamado de \textbf{Primitivos} e sua definição é ser uma das categorias: Null, Undefined, Boolean, Number ou String. Se um dado não é do tipo primitivo, então ele será um \textbf{Objeto} e pode ser . 
